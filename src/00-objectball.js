// The gameObject function that contains all the game data
function gameObject() {
    return {
      home: {
  ...
  // Bonus function: Find the player with the most points
  ...
  // Bonus function: Find the winning team
  ...
  // Bonus function: Find the player with the longest name
  ...
  // Super bonus function: Does the player with the longest name have the most steals?
